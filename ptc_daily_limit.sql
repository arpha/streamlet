-- ====================================================================
-- SKRIP MIGRASI PTC DAILY VIEW LIMITS
-- Jalankan skrip ini di SQL Editor dashboard Supabase Anda.
-- ====================================================================

-- 1. Tambah kolom daily_views_limit, daily_views_completed, last_reset_at ke tabel ptc_campaigns jika belum ada
...
-- 3. Definisikan ulang create_ptc_campaign dengan parameter p_daily_views_limit
...
-- 4. Definisikan ulang get_active_ptc_campaigns dengan logika reset harian
...
-- 5. Definisikan ulang claim_ptc_view dengan logika reset harian dan validasi limit harian
...
DECLARE
  ...
  v_new_balance INT;
BEGIN
  -- Reset daily views untuk campaign jika sudah berganti hari
  UPDATE public.ptc_campaigns
  SET daily_views_completed = 0,
      last_reset_at = now()
