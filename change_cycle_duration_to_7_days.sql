...
BEGIN
  IF p_type = 'faucet_shortlink' THEN
    CASE p_rank
      ...
      WHEN 2 THEN RETURN 35000;
      WHEN 3 THEN RETURN 25000;
      WHEN 4 THEN RETURN 20000;
      WHEN 5 THEN RETURN 15000;
      WHEN 6 THEN RETURN 12500;
      WHEN 7 THEN RETURN 10000;
      WHEN 8 THEN RETURN 9000;
      WHEN 9 THEN RETURN 8000;
      WHEN 10 THEN RETURN 7500;
      WHEN 11 THEN RETURN 5000;
      WHEN 12 THEN RETURN 5000;
      WHEN 13 THEN RETURN 5000;
      WHEN 14 THEN RETURN 5000;
      WHEN 15 THEN RETURN 5000;
      WHEN 16 THEN RETURN 3000;
      WHEN 17 THEN RETURN 3000;
      WHEN 18 THEN RETURN 3000;
      WHEN 19 THEN RETURN 3000;
      WHEN 20 THEN RETURN 3000;
      ELSE RETURN 0;
    END CASE;
