-- ====================================================================
-- SKRIP MIGRASI PENYIMPANAN DEVICE FINGERPRINT & USER AGENT KLAIM
-- Jalankan skrip ini di SQL Editor dashboard Supabase Anda.
-- ====================================================================

-- 1. Tambah kolom user_agent dan device_fingerprint ke faucet_claims
ALTER TABLE public.faucet_claims 
ADD COLUMN IF NOT EXISTS user_agent TEXT,
ADD COLUMN IF NOT EXISTS device_fingerprint TEXT;

-- 2. Tambah kolom user_agent dan device_fingerprint ke shortlink_claims
ALTER TABLE public.shortlink_claims 
ADD COLUMN IF NOT EXISTS user_agent TEXT,
ADD COLUMN IF NOT EXISTS device_fingerprint TEXT;


-- 3. Perbarui fungsi RPC claim_faucet agar menerima p_user_agent & p_device_fingerprint
...
BEGIN
  ...
  -- 3. Masukkan catatan klaim baru beserta IP, User Agent, dan Fingerprint
...
-- 4. Perbarui fungsi RPC start_shortlink_visit agar menerima p_user_agent & p_device_fingerprint
...
BEGIN
  ...
  -- 4. Masukkan pending claim beserta IP, User Agent, dan Fingerprint
...
-- 5. Perbarui fungsi RPC complete_shortlink_visit agar menerima p_callback_user_agent & p_callback_device_fingerprint
